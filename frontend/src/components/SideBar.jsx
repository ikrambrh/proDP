...
import { 
  Layers, Users, CheckSquare, Handshake, FileText, Shield, GraduationCap, BarChart, Book, Settings, Power 
} from "lucide-react";
...
export default function Sidebar() {
  return (
    <div className="w-64 h-screen bg-white shadow-md flex flex-col justify-between p-4">
      {/* Logo */}
      <div className="flex justify-left mb-6 pl-4 pt-2">
      ...
      <div className="mt-6 border-t pt-4">
        <SidebarItem icon={Settings} text="Paramètres" href="/parametres" />
        <SidebarItem icon={Power} text="Se déconnecter" href="/logout" />
      </div>
    </div>
  );
}
